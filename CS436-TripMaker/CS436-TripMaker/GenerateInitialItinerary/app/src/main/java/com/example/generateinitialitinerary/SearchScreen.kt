...
class SearchScreen : Fragment() {
    ...
    private var data = arrayOf("airport", "amusement_park", "aquarium", "art_gallery", "bakery",
        "bar", "beauty_salon", "bicycle_store", "book_store", "bowling_alley",
         "cafe", "campground", "casino", "cemetery", "church", "city_hall", "clothing_store",
        ...
        "local_government_office",  "meal_delivery", "meal_takeaway", "mosque",
        "movie_rental", "movie_theater", "museum", "night_club", "park", "pet_store",
         "restaurant", "rv_park", "shoe_store", "shopping_mall", "spa", "stadium",
            ...
            if (destination_name.size != 0){
                ...
                if (JSONResults.size != 0){
                    findNavController().navigate(
                        SearchScreenDirections.actionLoginFragmentToHelloFragment(JSONResults.toTypedArray())
                    )
                }
